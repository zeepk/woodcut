...
const Activities: NextPageWithLayout = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-screen flex min-h-screen flex-col items-center justify-start bg-white px-2 py-20 text-text-light dark:bg-background-dark dark:text-text-dark">
        <>
