...
const Rs3: NextPageWithLayout = () => {
  ...
  return (
    <>
      ...
      <main className="min-w-screen flex min-h-screen flex-col items-start justify-start bg-white p-10 text-text-500 dark:bg-zinc-900">
        <>
          <div className="flex items-center justify-start pb-5">
            <Avatar username={fetchName} />
            <h1 className="mb-4 text-4xl font-bold text-text-500">
              {fetchName.split("+").join(" ")}
            </h1>
          </div>
          <div className="divider dark:border-divider-400 w-full border border-gray-200" />
          {loading ? (
            <h1>Loading...</h1>
          ) : (
            <div>
...
const SortableTableHeader = ({
  ...
  <th
    className="cursor-pointer px-8 hover:bg-gray-200"
